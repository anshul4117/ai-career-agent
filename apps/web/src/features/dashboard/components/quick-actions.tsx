        ...
        {QUICK_ACTIONS.map((action, index) => {
          ...
          return (
            <motion.div variants={item} key={index}>
              <BrutalCard
                className="bg-surface border-[3px] border-border p-5 flex flex-col justify-between space-y-4 brutal-shadow transition-transform duration-150 hover:translate-x-[-2px] hover:translate-y-[-2px] hover:brutal-shadow-hover h-full"
              >
