...
import { WORK_PREFERENCE_LABELS } from "../data/profile.mock";
...
export function CareerSummaryCard({ career }: CareerSummaryCardProps) {
  return (
    <BrutalCard className="bg-surface border-[3px] border-border p-6 brutal-shadow w-full min-w-0">
      <div className="space-y-4">
        ...
        {career.summary && (
          <Text className="text-foreground-secondary text-sm leading-relaxed border-l-[3px] border-primary pl-4">
            {career.summary}
          </Text>
        )}
