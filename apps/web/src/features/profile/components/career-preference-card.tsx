...
export function CareerPreferenceCard({
  preferences,
        ...
        {!preferences ? (
          ...
          <div>
            ...
            <InfoRow
              label="Work Mode"
              value={
                WORK_MODE_LABELS[preferences.workMode] || preferences.workMode
              }
            />
            <InfoRow
              label="Expected Salary"
              value={`${preferences.currency || "INR"} ${preferences.expectedSalary}`}
            />
            ...
            />
            <InfoRow
              label="Relocate Willingness"
              value={preferences.relocationWillingness}
            />
            <InfoRow
              label="Sponsorship Needed"
              value={preferences.visaSponsorshipRequired}
            />
          </div>
        )}
      </div>
