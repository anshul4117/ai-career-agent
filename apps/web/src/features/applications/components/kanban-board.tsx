...
const COLUMNS: ColumnConfig[] = [
  { label: "Saved", status: "SAVED", colorClass: "border-slate-400 bg-slate-50" },
  { label: "Applied", status: "APPLIED", colorClass: "border-blue-400 bg-blue-50/20" },
  ...
  { label: "Interview", status: "INTERVIEW", colorClass: "border-amber-400 bg-amber-50/20" },
  { label: "Offer", status: "OFFER", colorClass: "border-emerald-400 bg-emerald-50/20" },
  { label: "Accepted", status: "ACCEPTED", colorClass: "border-green-500 bg-green-50/30" },
  { label: "Rejected", status: "REJECTED", colorClass: "border-rose-400 bg-rose-50/20" }
];
        ...
        return (
          <div
            ...
            className={cn(
              ...
              isHovered && "scale-[1.01] brutal-shadow border-primary bg-slate-50/50"
            )}
          >
            {/* Column Header */}
                ...
                columnApps.map((app) => (
                  ...
                  >
                      ...
                      <div className="flex justify-between items-start gap-1">
                        ...
                        <div className="hidden group-hover:flex items-center gap-0.5 bg-surface border border-border/40 p-0.5 rounded-sm shrink-0">
                          <button
                            ...
                            className="p-0.5 hover:bg-slate-100 rounded-sm text-foreground-muted hover:text-primary"
                    ...
                    <div className="flex items-center gap-1">
                      <Badge className="text-[6.5px] font-extrabold bg-green-50 text-green-700 border border-green-200 px-1 py-0 shadow-none rounded-none shrink-0">
                        {app.matchScore}% Match
                      </Badge>
                      <Badge className="text-[6.5px] font-extrabold bg-blue-50 text-blue-700 border border-blue-200 px-1 py-0 shadow-none rounded-none shrink-0">
