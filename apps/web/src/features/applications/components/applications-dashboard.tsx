...
export function ApplicationsDashboard({
  ...
  const stats = React.useMemo(() => {
    ...
    // Total Applications represent any job that has actually been submitted (status !== "SAVED")
    ...
    return {
      ...
      rejected,
      withdrawn,
      active: totalApplications - accepted - rejected - withdrawn,
    };
  }, [applications]);
  ...
  const followUpReminders = React.useMemo(() => {
    return applications.filter(
      (a) =>
        a.followUpNotes && (a.status === "APPLIED" || a.status === "SCREENING"),
    );
  }, [applications]);
  ...
  const points = monthlyData
    .map((d, i) => {
      const x =
        padding + (i * (chartWidth - padding * 2)) / (monthlyData.length - 1);
      const y =
        chartHeight -
        padding -
        (d.count * (chartHeight - padding * 2)) / maxCount;
      return `${x},${y}`;
    })
    .join(" ");
    ...
    <div className="space-y-6 text-left select-none">
      ...
      <div className="space-y-2">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-6 gap-3">
          <BrutalCard className="border-2 border-border bg-surface p-3 rounded-sm brutal-shadow-xs flex items-center gap-2.5">
            <div className="h-8 w-8 border-2 border-border bg-blue-100 dark:bg-blue-500/20 flex items-center justify-center rounded-sm text-blue-700 dark:text-blue-400 shrink-0">
              <ClipboardList className="h-4.5 w-4.5 stroke-[2.5px]" />
            </div>
            <div>
          ...
          <BrutalCard className="border-2 border-border bg-surface p-3 rounded-sm brutal-shadow-xs flex items-center gap-2.5">
            <div className="h-8 w-8 border-2 border-border bg-indigo-100 dark:bg-indigo-500/20 flex items-center justify-center rounded-sm text-indigo-700 dark:text-indigo-400 shrink-0">
          ...
          <BrutalCard className="border-2 border-border bg-surface p-3 rounded-sm brutal-shadow-xs flex items-center gap-2.5">
            <div className="h-8 w-8 border-2 border-border bg-amber-100 dark:bg-amber-500/20 flex items-center justify-center rounded-sm text-amber-700 dark:text-amber-400 shrink-0">
              <Video className="h-4.5 w-4.5 stroke-[2.5px]" />
            </div>
            <div>
              <span className="text-[7.5px] font-black text-foreground-muted uppercase block">
                Interview
          ...
          <BrutalCard className="border-2 border-border bg-surface p-3 rounded-sm brutal-shadow-xs flex items-center gap-2.5">
            <div className="h-8 w-8 border-2 border-border bg-green-100 dark:bg-green-500/20 flex items-center justify-center rounded-sm text-green-700 dark:text-green-400 shrink-0">
          ...
          <BrutalCard className="border-2 border-border bg-surface p-3 rounded-sm brutal-shadow-xs flex items-center gap-2.5">
            <div className="h-8 w-8 border-2 border-border bg-rose-100 dark:bg-rose-500/20 flex items-center justify-center rounded-sm text-rose-700 dark:text-rose-400 shrink-0">
              <XOctagon className="h-4.5 w-4.5 stroke-[2.5px]" />
            </div>
            <div>
              <span className="text-[7.5px] font-black text-foreground-muted uppercase block">
                Rejected
          ...
          <BrutalCard className="border-2 border-border bg-surface p-3 rounded-sm brutal-shadow-xs flex items-center gap-2.5">
            <div className="h-8 w-8 border-2 border-border bg-slate-100 dark:bg-slate-500/20 flex items-center justify-center rounded-sm text-slate-700 dark:text-slate-400 shrink-0">
              <Bookmark className="h-4.5 w-4.5 stroke-[2.5px]" />
            </div>
            <div>
              <span className="text-[7.5px] font-black text-foreground-muted uppercase block">
                Saved Jobs
      ...
      <div className="space-y-2">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
          <BrutalCard className="border-[3px] border-border bg-surface p-4 rounded-sm brutal-shadow-xs space-y-1">
            ...
            <div
              ...
              role="progressbar"
              aria-valuenow={conversion.acceptanceRate}
              aria-valuemin={0}
              aria-valuemax={100}
              aria-label="Application Success Progress"
            >
              <div
                className="h-full bg-green-500"
                style={{ width: `${conversion.acceptanceRate}%` }}
              />
            </div>
          </BrutalCard>
          ...
          <BrutalCard className="border-[3px] border-border bg-surface p-4 rounded-sm brutal-shadow-xs space-y-1">
            <div className="flex justify-between items-center text-[9px] font-black uppercase">
              ...
              <span className="text-blue-600 dark:text-blue-400">
                {conversion.responseRate}%
              </span>
            </div>
            <div className="text-lg font-black">{conversion.responseRate}%</div>
            <div
              className="h-2 w-full bg-slate-100 dark:bg-surface-hover border border-border rounded-sm overflow-hidden"
              role="progressbar"
              aria-valuenow={conversion.responseRate}
              aria-valuemin={0}
              aria-valuemax={100}
            ...
            >
              <div
                ...
                style={{ width: `${conversion.responseRate}%` }}
              />
            </div>
          </BrutalCard>
          ...
          <BrutalCard className="border-[3px] border-border bg-surface p-4 rounded-sm brutal-shadow-xs space-y-1">
            ...
            <div
              className="h-2 w-full bg-slate-100 dark:bg-surface-hover border border-border rounded-sm overflow-hidden"
              role="progressbar"
              aria-valuenow={conversion.interviewRate}
              aria-valuemin={0}
              aria-valuemax={100}
              aria-label="Interview Rate Progress"
            >
              <div
                className="h-full bg-amber-500"
                style={{ width: `${conversion.interviewRate}%` }}
              />
            </div>
          </BrutalCard>
          ...
          <BrutalCard className="border-[3px] border-border bg-surface p-4 rounded-sm brutal-shadow-xs space-y-1">
            <div className="flex justify-between items-center text-[9px] font-black uppercase">
              ...
              <span className="text-purple-600 dark:text-purple-400">
                {conversion.offerRate}%
              </span>
            </div>
            <div className="text-lg font-black">{conversion.offerRate}%</div>
            <div
              className="h-2 w-full bg-slate-100 dark:bg-surface-hover border border-border rounded-sm overflow-hidden"
              role="progressbar"
              aria-valuenow={conversion.offerRate}
              aria-valuemin={0}
              aria-valuemax={100}
              aria-label="Offer Rate Progress"
            >
              <div
                className="h-full bg-purple-500"
                style={{ width: `${conversion.offerRate}%` }}
              />
            </div>
          </BrutalCard>
        </div>
      ...
      {/* 3. Grid split: funnel conversions vs monthly charts */}
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <BrutalCard className="border-[3px] border-border bg-surface p-5 rounded-sm brutal-shadow-xs space-y-4">
          <h3 className="text-[10px] font-black uppercase tracking-widest text-foreground border-b-2 border-border/10 pb-2 flex items-center gap-1.5">
            <TrendingUp className="h-4 w-4 text-primary" /> Application Funnel
            Analytics
          </h3>
          ...
          <div className="space-y-3.5">
            ...
            <div className="space-y-1">
              ...
              <div
                className="h-3 w-full bg-slate-100 dark:bg-surface-hover border-2 border-border rounded-sm overflow-hidden"
                role="progressbar"
                aria-valuenow={conversion.responseRate}
                aria-valuemin={0}
                aria-valuemax={100}
                aria-label="Employer Response Rate Progress"
              >
                <div
                  className="h-full bg-blue-500 border-r border-border"
                  style={{ width: `${conversion.responseRate}%` }}
                />
              </div>
            </div>
            ...
            <div className="space-y-1">
              ...
              <div
                ...
                aria-valuemin={0}
                aria-valuemax={100}
                aria-label="Interview Invitation Rate Progress"
              >
                <div
                  className="h-full bg-amber-500 border-r border-border"
                  style={{ width: `${conversion.interviewRate}%` }}
                />
              </div>
            </div>
            ...
            <div className="space-y-1">
              ...
              <div
                ...
                aria-valuemin={0}
                aria-valuemax={100}
                aria-label="Offer Conversion Rate Progress"
              >
                <div
                  className="h-full bg-green-500 border-r border-border"
                  style={{ width: `${conversion.offerRate}%` }}
                />
              </div>
            </div>
          ...
          <div className="w-full flex justify-center items-center py-4 bg-slate-50/40 dark:bg-surface-secondary/40 border border-border/10 rounded-sm mt-3">
            ...
            >
              ...
              {monthlyData.map((d, i) => {
                const x =
                  padding +
                  (i * (chartWidth - padding * 2)) / (monthlyData.length - 1);
                const y =
                  chartHeight -
                  padding -
                  (d.count * (chartHeight - padding * 2)) / maxCount;
      ...
      <div className="grid gap-6 md:grid-cols-3">
        ...
        <BrutalCard className="border-[3px] border-border bg-surface p-4 rounded-sm brutal-shadow-xs flex flex-col justify-between space-y-3">
          <div>
            ...
            {upcomingInterviews.length > 0 ? (
                ...
                {upcomingInterviews.map((app) => (
                  ...
                  >
                    <div className="flex justify-between items-start">
                      ...
                      <Badge className="text-[6.5px] font-black uppercase bg-amber-100 dark:bg-amber-500/20 text-amber-800 dark:text-amber-300 border-amber-300 dark:border-amber-500/30 border py-0 px-1 rounded-none shadow-none">
                        {app.interviewRound}
                      </Badge>
                    </div>
                    <h4 className="font-black uppercase text-[10.5px] tracking-tight truncate">
                      {app.jobTitle}
                    </h4>
                    ...
                    <div className="text-[8px] font-bold text-foreground-secondary space-y-1">
                      ...
                      {app.interviewerName && (
                        <div className="flex items-center gap-1.5">
                          <UserCheck className="h-3 w-3 text-foreground-muted" />{" "}
              ...
              <p className="text-foreground-muted text-[9px] font-bold uppercase py-6 text-center">
                No upcoming rounds.
              </p>
            )}
          </div>
        ...
        <BrutalCard className="border-[3px] border-border bg-surface p-4 rounded-sm brutal-shadow-xs flex flex-col justify-between space-y-3">
                    ...
                    <div className="flex justify-between items-start">
                      ...
                      {app.offerDeadline && (
                        <Badge className="text-[6px] font-black bg-rose-100 dark:bg-rose-500/20 text-rose-800 dark:text-rose-300 border-rose-300 dark:border-rose-500/30 border py-0 px-1 rounded-none shadow-none flex items-center gap-0.5">
                          <AlertCircle className="h-2 w-2" /> Expires:{" "}
                          {app.offerDeadline}
                        </Badge>
                      )}
                    </div>
                    <h4 className="font-black uppercase text-[10.5px] tracking-tight truncate text-emerald-950">
                      {app.jobTitle}
                    </h4>
                    <p className="text-[8.5px] font-bold text-emerald-800">
                      {app.salaryNotes}
                    </p>
                  </div>
                ))}
          ...
          <div className="border-t border-border/10 pt-3">
            ...
            {followUpReminders.length > 0 ? (
              <div className="space-y-2 max-h-[100px] overflow-y-auto pr-1">
                {followUpReminders.map((app) => (
                  ...
                  >
                    ...
                    <Badge className="text-[6.5px] font-black bg-blue-100 dark:bg-blue-500/20 text-blue-800 dark:text-blue-300 border-none px-1 rounded-none">
                      Active
                    </Badge>
                  </div>
                ))}
              ...
              <p className="text-foreground-muted text-[7.5px] font-bold uppercase py-2">
        ...
        <BrutalCard className="border-[3px] border-border bg-surface p-4 rounded-sm brutal-shadow-xs flex flex-col justify-between space-y-3">
              ...
              {weeklyActivity.map((count, idx) => {
                ...
                return (
                  ...
                  >
                    ...
                    />
                    <span className="text-[6px] font-black text-foreground-muted">
                      {weekdayNames[idx]}
                    </span>
                  </div>
                );
          ...
          <div className="border-t border-border/10 pt-3">
            <h4 className="text-[9px] font-black uppercase text-foreground flex items-center gap-1 mb-2">
              <FileText className="h-3.5 w-3.5 text-foreground-secondary" />{" "}
              Recent Applications
            </h4>
            ...
            <div className="space-y-2">
              {recentApplications.map((app) => (
                ...
                >
                  ...
                  <span className="text-foreground-muted text-[6.5px] shrink-0">
