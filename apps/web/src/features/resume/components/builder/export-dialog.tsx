            ...
            <div className="space-y-2.5 pt-2 border-t-2 border-border/10">
              {(
                [
                  ...
                  {
                    key: "pageBreakPreview",
                    label: "Show Page Break Line Guides",
                  },
                  {
                    key: "sectionBreaks",
                    label: "Force Page Break per Section",
                  },
                ] as const
              ).map((opt) => {
                const key = opt.key;
        ...
        <div className="w-full md:w-1/2 p-4 md:p-6 flex flex-col justify-between overflow-y-auto max-h-[45vh] md:max-h-none">
          ...
          <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-6">
              {/* PDF Print trigger */}
              <BrutalCard
                className="p-3 bg-surface hover:bg-primary/5 transition-colors cursor-pointer border-2 border-border"
