...
export function OptimizationStudio() {
  ...
  const handleExport = async (format: "pdf" | "docx") => {
    ...
    toast.success(
      `Exported successfully as ${format.toUpperCase()}! File saved: ${path}`,
    );
  };
      ...
      <div className="flex flex-col items-center justify-center min-h-[50vh] text-center p-6 space-y-4">
        ...
        <div className="space-y-1">
          ...
          <p className="text-xs text-foreground-secondary max-w-sm">
            Paste a target Job Description in the left panel and trigger the
            scan to unlock diffs, bullet enhancers, and versions trackers.
          </p>
        </div>
      </div>
    );
          ...
          <div className="space-y-4 animate-in fade-in duration-200">
            <BrutalCard className="border-[3px] border-border bg-surface p-4 rounded-sm brutal-shadow-xs space-y-4">
              <div>
                ...
                <p className="text-[8px] text-foreground-muted uppercase">
                  Highlights text level edits and metrics adjustments
                </p>
              </div>
              ...
              <div className="grid gap-4 md:grid-cols-2 text-[10.5px] leading-relaxed">
                ...
                <div className="p-3 border border-border bg-slate-50/50 dark:bg-surface-secondary/50 rounded-sm space-y-2">
                  <span className="text-[7.5px] font-black text-rose-700 dark:text-rose-400 uppercase bg-rose-50 dark:bg-rose-500/10 border border-rose-200 px-1 py-0.5 rounded-none shadow-none">
                    Original Summary
                  </span>
                ...
                <div className="p-3 border-2 border-green-400 dark:border-green-500/40 bg-green-50 dark:bg-green-500/10/10 rounded-sm space-y-2">
                  <span className="text-[7.5px] font-black text-green-700 dark:text-green-400 uppercase bg-green-50 dark:bg-green-500/10 border border-green-200 px-1 py-0.5 rounded-none shadow-none">
                    AI Optimized Summary
                  </span>
                  <p className="text-green-950 font-medium bg-green-50 dark:bg-green-500/10/30 p-1.5 rounded-sm">
                    {analysis.summaryOpt.improved}
                  </p>
                  <p className="text-[8.5px] text-foreground-muted font-bold pt-1.5 border-t border-border/10">
                    Rationale: {analysis.summaryOpt.rationale}
                  </p>
                </div>
              </div>
            </BrutalCard>
          ...
          <div className="space-y-4 animate-in fade-in duration-200">
            <BrutalCard className="border-[3px] border-border bg-surface p-4 rounded-sm brutal-shadow-xs space-y-4">
              <div>
                ...
                <p className="text-[8px] text-foreground-muted uppercase">
                  Converts passive phrases into metric-infused metrics
                </p>
              </div>
              ...
              <div className="space-y-3">
                {analysis.bullets.map((b, idx) => (
                  <div
                    key={idx}
                    className="p-3 border border-border bg-surface rounded-sm flex flex-col md:flex-row gap-3 items-stretch"
                  >
                    {/* Before */}
                    <div className="flex-1 space-y-1">
                      <span className="text-[7px] font-black text-foreground-muted uppercase">
                        Original bullet
                      </span>
                      <p className="text-[10.5px] text-foreground-secondary italic leading-relaxed">
                        {b.original}
                      </p>
                    </div>
                    {/* Arrow spacer */}
                    ...
                    <div className="flex-1 space-y-1 border-t md:border-t-0 md:border-l border-border/10 pt-2 md:pt-0 md:pl-3">
                      <span className="text-[7.5px] font-black text-primary uppercase">
                        Optimized version
                      </span>
                      <p className="text-[10.5px] text-foreground font-black leading-relaxed text-green-950 bg-green-50 dark:bg-green-500/10/10 p-1 rounded-xs">
                        {b.improved}
                      </p>
                      <span className="text-[8px] font-bold text-foreground-muted block mt-1.5">
                        {b.impact}
                      </span>
                    </div>
                  </div>
            ...
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <BrutalCard className="border-[3px] border-border bg-surface p-4 rounded-sm brutal-shadow-xs flex flex-col justify-between">
                ...
                <div className="py-6 flex flex-col items-center justify-center">
                  ...
                  <span className="text-[8.5px] font-black uppercase tracking-wider text-foreground mt-3">
                    Tone: {analysis.readability.tone}
                  </span>
                </div>
              </BrutalCard>
                ...
                <div className="space-y-3.5">
                  <div className="space-y-1">
                    ...
                    <div className="h-2 w-full bg-slate-100 dark:bg-surface-hover border border-border rounded-sm overflow-hidden">
                      <div
                        ...
                        style={{
                          width: `${Math.min(100, (analysis.readability.sentenceLength / 25) * 100)}%`,
                        }}
                      />
                    </div>
                  </div>
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="h-2 w-full bg-slate-100 dark:bg-surface-hover border border-border rounded-sm overflow-hidden">
                      <div
                        ...
                        style={{
                          width: `${Math.min(100, (analysis.readability.passiveVoiceCount / 8) * 100)}%`,
                        }}
                      />
                    </div>
                  </div>
                  ...
                  <div className="space-y-1">
                    <div className="flex justify-between items-center text-[9px] font-black uppercase">
                      ...
                      <span>
                        {analysis.readability.grammarWarningsCount} flagged
                      </span>
                    </div>
                    <div className="h-2 w-full bg-slate-100 dark:bg-surface-hover border border-border rounded-sm overflow-hidden">
                      <div
                        ...
                        style={{
                          width: `${Math.min(100, (analysis.readability.grammarWarningsCount / 5) * 100)}%`,
                        }}
                      />
                    </div>
                  </div>
            ...
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <BrutalCard className="border-[3px] border-border bg-surface p-4 rounded-sm brutal-shadow-xs space-y-4">
                ...
                <div className="space-y-2 max-h-[220px] overflow-y-auto pr-1">
                  {versions.map((ver) => (
                    ...
                    >
                      <div>
                        <span className="text-[10.5px] font-black uppercase block">
                          {ver.name}
                        </span>
                        <span className="text-[8px] text-foreground-muted block font-mono">
                          Created: {ver.createdAt.split("T")[0]}
                        </span>
                      </div>
                      <Badge className="text-[7px] font-black uppercase bg-primary text-white border-none py-0.5 px-1 shadow-none rounded-none">
                        ATS: {ver.atsScore}%
                      </Badge>
                    </div>
                  ))}
                ...
                <form
                  ...
                  className="flex gap-2 border-t border-border/10 pt-3"
                >
                  <input
                    type="text"
                  ...
                  <BrutalButton
                    type="submit"
                    className="h-8 px-3 text-[9px] font-black uppercase shrink-0"
                  >
                    Add Version
                  </BrutalButton>
                </form>
              ...
              <BrutalCard className="border-[3px] border-border bg-surface p-4 rounded-sm brutal-shadow-xs space-y-4">
                ...
                <p className="text-[9px] text-foreground-secondary leading-relaxed">
                  Download this optimized variant to your desktop files using
                  the mock system.
                </p>
              ...
              {history.length > 0 ? (
                <div className="space-y-2 max-h-[250px] overflow-y-auto pr-1">
                  {history.map((item) => (
                    <div
                      key={item.id}
                      className="p-2 border border-border bg-slate-50/50 dark:bg-surface-secondary/50 rounded-sm flex justify-between items-center text-[9px] font-bold uppercase"
                    >
                      <div>
                        <span className="font-black text-foreground block">
                          {item.jobTitle}
                        </span>
                        <span className="text-[7.5px] text-foreground-muted block font-mono">
                          Date: {item.date} | Active Profile: {item.version}
                        </span>
                      </div>
                      <Badge className="text-[7px] font-black bg-primary text-white border-none rounded-none">
                        {item.atsScore}% Score
                      </Badge>
                    </div>
                  ))}
                ...
                <p className="text-foreground-muted text-[9px] font-bold uppercase text-center py-6">
                  No past optimization logs available.
                </p>
              )}
            </BrutalCard>
          </div>
