...
export function JobDetailsPane({ job }: JobDetailsPaneProps) {
  ...
  const handleRecalculate = async () => {
    ...
    const latestQualityScore = latestQualityReport
      ? latestQualityReport.overallScore
      : 80;
    ...
    <div className="space-y-6 text-left pb-24 md:pb-16 select-none">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <div className="p-3 border-2 border-border brutal-shadow-xs bg-surface rounded-sm">
          <p className="text-[8px] font-black uppercase text-foreground-muted">
            Compensation
          </p>
        ...
        <div className="md:col-span-2 space-y-6">
          ...
          <BrutalCard className="border-2 border-border bg-surface p-5 rounded-sm">
            ...
            <ul className="space-y-2 max-w-3xl">
              {job.responsibilities.map((resp, i) => (
                <li
                  key={i}
                  className="flex gap-2 text-xs font-semibold text-foreground-secondary leading-relaxed"
                >
          ...
          {matchLoading[job.id] ? (
            ...
            <BrutalCard className="border-2 border-border bg-surface p-5 rounded-sm text-center py-6">
              <p className="text-xs font-bold text-error uppercase mb-2">
                Match analysis could not be retrieved.
              </p>
              <Button
                  ...
                  <BrutalCard className="border-2 border-border bg-surface p-5 rounded-sm">
                    <h3 className="text-[10px] font-black uppercase tracking-widest text-foreground border-b-2 border-border/10 pb-2 mb-4 flex justify-between items-center">
                      ...
                      <span
                        className={cn(
                          ...
                          matchReport.overallScore >= 70 &&
                            "bg-amber-50 dark:bg-amber-500/10 text-amber-700 dark:text-amber-400 border-amber-300 dark:border-amber-500/30",
                          matchReport.overallScore >= 50 &&
                            "bg-gray-50 dark:bg-surface-secondary text-gray-700 dark:text-foreground-secondary border-gray-300",
                          matchReport.overallScore < 50 &&
                    ...
                    <div className="grid gap-4 sm:grid-cols-2">
                      ...
                      <div className="space-y-1">
                        ...
                        <div
                          className="h-2.5 w-full bg-slate-100 dark:bg-surface-hover border border-border/25 rounded-sm overflow-hidden"
                          role="progressbar"
                          aria-valuenow={matchReport.skills.score}
                          aria-valuemin={0}
                          aria-valuemax={100}
                        ...
                        >
                          <div
                            ...
                            style={{ width: `${matchReport.skills.score}%` }}
                          />
                        </div>
                      </div>
                      ...
                      <div className="space-y-1">
                        ...
                        <div
                          className="h-2.5 w-full bg-slate-100 dark:bg-surface-hover border border-border/25 rounded-sm overflow-hidden"
                          role="progressbar"
                          aria-valuenow={matchReport.experience.score}
                          aria-valuemin={0}
                          aria-valuemax={100}
                          aria-label="Experience Match Progress"
                        >
                          <div
                            className="h-full bg-primary"
                            style={{
                              width: `${matchReport.experience.score}%`,
                            }}
                          />
                        </div>
                      </div>
                      ...
                      <div className="space-y-1">
                        ...
                        <div
                          className="h-2.5 w-full bg-slate-100 dark:bg-surface-hover border border-border/25 rounded-sm overflow-hidden"
                          role="progressbar"
                          aria-valuenow={matchReport.location.score}
                          aria-valuemin={0}
                          aria-valuemax={100}
                          aria-label="Location Match Progress"
                        >
                          <div
                            className="h-full bg-primary"
                            style={{ width: `${matchReport.location.score}%` }}
                          />
                        </div>
                      </div>
                      ...
                      <div className="space-y-1">
                        ...
                        <div
                          className="h-2.5 w-full bg-slate-100 dark:bg-surface-hover border border-border/25 rounded-sm overflow-hidden"
                          role="progressbar"
                          aria-valuenow={matchReport.salary.score}
                          aria-valuemin={0}
                          aria-valuemax={100}
                          aria-label="Salary Match Progress"
                        >
                          <div
                            className="h-full bg-primary"
                            style={{ width: `${matchReport.salary.score}%` }}
                          />
                        </div>
                      </div>
                      ...
                      <div className="space-y-1">
                        ...
                        <div
                          className="h-2.5 w-full bg-slate-100 dark:bg-surface-hover border border-border/25 rounded-sm overflow-hidden"
                          role="progressbar"
                          aria-valuenow={matchReport.education.score}
                          aria-valuemin={0}
                          aria-valuemax={100}
                          aria-label="Education Match Progress"
                        >
                          <div
                            className="h-full bg-primary"
                            style={{ width: `${matchReport.education.score}%` }}
                          />
                        </div>
                      </div>
                      ...
                      <div className="space-y-1">
                        ...
                        <div
                          className="h-2.5 w-full bg-slate-100 dark:bg-surface-hover border border-border/25 rounded-sm overflow-hidden"
                          role="progressbar"
                          aria-valuenow={matchReport.quality.score}
                          aria-valuemin={0}
                          aria-valuemax={100}
                          aria-label="Job Quality Match Progress"
                        >
                          <div
                            className="h-full bg-primary"
                            style={{ width: `${matchReport.quality.score}%` }}
                          />
                        </div>
                      </div>
                    </div>
                      ...
                      <ul className="space-y-2 text-xs font-semibold leading-relaxed">
                        {matchReport.reasons.map((reason, idx) => (
                          ...
                          >
                            <span
                              className={cn(
                                "shrink-0 font-extrabold text-[9px] leading-none",
                                reason.met
                    ...
                    <BrutalCard className="border-2 border-border bg-surface p-5 rounded-sm space-y-3.5">
                      ...
                      <div className="space-y-1">
                        ...
                        <div className="flex flex-wrap gap-1">
                          {matchReport.skills.matched.length > 0 ? (
                            matchReport.skills.matched.map((s) => (
                              <Badge
                                key={s}
                                className="text-[7.5px] font-bold bg-green-50 dark:bg-green-500/10 text-green-700 dark:text-green-400 border border-green-300 dark:border-green-500/30 shadow-none px-1.5 py-0.5 rounded-sm"
                              >
                                {s}
                              </Badge>
                            ))
                          ) : (
                            <span className="text-[8px] font-bold text-foreground-muted italic">
                      ...
                      <div className="space-y-1">
                        ...
                        <div className="flex flex-wrap gap-1">
                          {matchReport.skills.missing.length > 0 ? (
                            matchReport.skills.missing.map((s) => (
                              <Badge
                                key={s}
                                className="text-[7.5px] font-bold bg-red-50 text-red-700 border border-red-300 shadow-none px-1.5 py-0.5 rounded-sm"
                              >
                                {s}
                              </Badge>
                            ))
                            ...
                            <span className="text-[8px] font-bold text-foreground-muted italic">
                              None! You possess all required skills.
                            </span>
                          )}
                        </div>
                      </div>
                      ...
                      <div className="space-y-1">
                        ...
                        <div className="flex flex-wrap gap-1">
                          {matchReport.skills.additional
                            .slice(0, 6)
                            .map((s) => (
                              <Badge
                                key={s}
                                className="text-[7.5px] font-bold bg-surface border border-border/20 text-foreground-secondary shadow-none px-1.5 py-0.5 rounded-sm"
                              >
                                {s}
                              </Badge>
                            ))}
                          {matchReport.skills.additional.length > 6 && (
                            <span className="text-[8px] font-bold text-foreground-muted">
                              +{matchReport.skills.additional.length - 6} more
                            </span>
                          )}
                        </div>
                      </div>
                    ...
                    <BrutalCard className="border-2 border-border bg-surface p-5 rounded-sm">
                      ...
                      <div className="grid gap-3.5 sm:grid-cols-2">
                        {matchReport.recommendations.map((rec, idx) => (
                          <div
                            key={idx}
                            className="p-3 border border-border/20 rounded-sm bg-surface-secondary/20 flex gap-2.5 items-start"
                          >
          ...
          <BrutalCard className="border-2 border-border bg-surface p-5 rounded-sm">
            ...
            <div className="flex flex-wrap gap-1.5 max-w-3xl">
              {job.benefits.map((ben) => (
                <Badge
                  key={ben}
                  className="text-[9px] font-bold bg-surface-secondary border border-border/40 text-foreground-secondary px-2 py-0.5"
                >
                  {ben}
                </Badge>
              ))}
          ...
          <BrutalCard className="border-2 border-border bg-surface p-5 rounded-sm space-y-4">
            <div className="flex justify-between items-center border-b-2 border-border/10 pb-2">
              ...
              <div className="relative group inline-block">
                ...
                <div className="absolute right-0 top-full mt-1.5 w-56 bg-foreground text-surface p-3 text-[8.5px] leading-relaxed brutal-shadow border-2 border-border hidden group-hover:block group-focus-within:block z-30 font-bold uppercase rounded-sm">
                  <p className="border-b border-border/20 pb-1 mb-1 text-accent">
                  ...
                  <ul className="space-y-1 normal-case font-semibold text-slate-200">
                    <li className="flex items-start gap-1">
                      ...
                      <span>
                        <strong>Freshness (40%)</strong>: Age of posting.
                    ...
                    <li className="flex items-start gap-1">
                      <span className="text-accent font-black">•</span>
                      <span>
                        <strong>Trust (60%)</strong>: Evaluates site links, logo
                        presence, descriptions, and recruiters.
                      </span>
                    </li>
                    <li className="flex items-start gap-1">
                      <span className="text-accent font-black">•</span>
                      <span>
                        <strong>Duplicates Penalty</strong>: Deduplication
                        filters cap overall score to Poor.
                      </span>
                    </li>
                  </ul>
                </div>
            ...
            {isQloading ? (
              ...
              <div className="space-y-2.5 py-1 text-center">
                <p className="text-[9px] font-bold text-error uppercase">
                  {qError}
                </p>
                <Button
                  onClick={handleRecalculate}
              ...
              <div className="space-y-4">
                ...
                {(() => {
                  ...
                  // Compute warning badges dynamically
                  const warnings = [];
                  if (job.salaryMin === null && job.salaryMax === null)
                    warnings.push("Missing Salary");
                  const ageMs = Date.now() - new Date(job.postedDate).getTime();
                  if (ageMs > 30 * 24 * 60 * 60 * 1000)
                    warnings.push("Expired Job");
                  if (job.trustScore < 80) warnings.push("Unverified Company");
                  if (job.trustScore < 50) warnings.push("Suspicious Job");
                  if (job.externalApplyUrl && !job.easyApply)
                    warnings.push("External Redirect");
                  if (job.description.length < 150)
                    warnings.push("Incomplete Description");

                  // Get AI Insights
                  const getAIInsights = () => {
                    if (report.overallScore >= 90) {
                      return {
                        pros: "Verified hiring partner, transparent compensation structure, detailed requirements, and active hiring status.",
                        cons: "High applicant competition due to attractive benefits.",
                        summary:
                          "Strongly recommended to apply early using Easy Apply.",
                      };
                    } else if (report.overallScore >= 75) {
                      return {
                        pros: "Clear description, active hiring tag, and legitimate company profile verified.",
                        cons: "Redirects to external portal, which might require re-entering application details.",
                        summary:
                          "Solid opportunity with reliable credentials; recommended to apply.",
                      };
                    } else if (report.overallScore >= 50) {
                      return {
                        pros: "Active listings from known companies with verified websites.",
                        cons: "Missing salary disclosure range and external redirect portal.",
                        summary:
                          "Good opportunity; verify external recruitment guidelines before submission.",
                      };
                    } else {
                      return {
                        pros: "None identified.",
                        cons: "Outdated post age, missing salary disclosures, unverified company, or duplicate detection triggers.",
                        summary:
                          "Proceed with caution; potential duplicate or outdated listing.",
                      };
                    }
                  };
                  ...
                  return (
                    <div className="space-y-4">
                        ...
                        <div className="relative h-12 w-12 flex items-center justify-center shrink-0">
                          <svg className="absolute transform -rotate-90 w-12 h-12">
                            <circle
                              ...
                              cy="24"
                              r={radius}
                              className="stroke-slate-100 dark:stroke-surface-hover fill-none stroke-2"
                            />
                            <circle
                              cx="24"
                              cy="24"
                              r={radius}
                              className={cn(
                                "fill-none stroke-2 transition-all duration-500",
                          ...
                          <span className="font-mono text-[9px] font-black text-foreground">
                            {report.overallScore}%
                          </span>
                        </div>
                        <div className="text-left space-y-0.5">
                          <p className="text-[9px] font-black uppercase text-foreground-secondary">
                            Audit Quality Score
                          </p>
                          <span
                            className={cn(
                              "font-black text-[8px] uppercase px-1.5 py-0.2 border border-border rounded-sm brutal-shadow-xs inline-block",
                              report.overallLabel === "Excellent" &&
                                "bg-green-100 dark:bg-green-500/20 text-green-700 dark:text-green-400",
                              report.overallLabel === "Good" &&
                                "bg-blue-100 dark:bg-blue-500/20 text-blue-700 dark:text-blue-400",
                              report.overallLabel === "Average" &&
                                "bg-amber-100 dark:bg-amber-500/20 text-amber-700 dark:text-amber-400",
                              report.overallLabel === "Poor" &&
                      ...
                      {warnings.length > 0 && (
                        <div className="border-t border-border/10 pt-2.5 space-y-1.5 text-left">
                          <p className="text-[8px] font-black uppercase tracking-wider text-error">
                            Warning Indicators ({warnings.length})
                          </p>
                          <div className="flex flex-wrap gap-1">
                            {warnings.map((w) => (
                              <Badge
                                key={w}
                                className="bg-red-50 text-red-700 border border-red-300 text-[7px] font-extrabold uppercase px-1.5 py-0.2 rounded-sm shadow-none"
                              >
                                {w}
                              </Badge>
                            ))}
                        ...
                        <div className="flex justify-between items-center">
                          ...
                          <Badge
                            className={cn(
                              ...
                              report.duplicateStatus === "Unique" &&
                                "bg-green-50 dark:bg-green-500/10 text-green-700 dark:text-green-400 border-green-300 dark:border-green-500/30",
                              report.duplicateStatus === "Possible Duplicate" &&
                                "bg-amber-50 dark:bg-amber-500/10 text-amber-700 dark:text-amber-400 border-amber-300 dark:border-amber-500/30",
                              report.duplicateStatus === "Duplicate" &&
                                "bg-red-50 text-red-700 border-red-300",
                            )}
                          >
                      ...
                      <details className="text-[9px] font-black uppercase text-foreground-secondary border-t border-border/10 pt-3 cursor-pointer group">
                        ...
                        <ul className="space-y-1.5 mt-3 text-[8px] font-semibold normal-case">
                          {report.trustFactors.map((factor) => (
                            <li
                              key={factor.name}
                              className="flex items-start gap-1.5 leading-tight text-left"
                            >
                              <span
                                className={cn(
                                  "shrink-0 font-extrabold text-[9px] leading-none",
                              ...
                              <div className="flex flex-col text-[8.5px]">
                                <span
                                  className={cn(
                                    "font-bold uppercase text-[7.5px]",
                                    factor.met
                                      ? "text-foreground"
                                      : "text-foreground-muted",
                                  )}
                                ...
                                <span className="text-foreground-muted leading-tight mt-0.5">
                                  {factor.met
                                    ? factor.description
                                    : `${factor.name} was not found on this listing.`}
                                </span>
                              </div>
                            </li>
                          ))}
                      ...
                      {/* AI Quality Insights */}
                      <div className="border-2 border-dashed border-primary/40 bg-purple-50/10 dark:bg-purple-950/10 p-3 space-y-2 rounded-sm text-left mt-3">
                        <div className="flex items-center gap-1 text-[9px] font-black uppercase text-primary">
                          <Sparkles className="h-3.5 w-3.5" /> AI Quality
                          Insights
                        </div>
                        <div className="space-y-1.5 text-[8.5px] font-semibold text-foreground-secondary leading-relaxed normal-case">
                          <p>
                            <strong className="uppercase text-[7px] text-green-600 block">
                              Pros & Advantages:
                            </strong>{" "}
                            {insights.pros}
                          </p>
                          <p>
                            <strong className="uppercase text-[7px] text-amber-600 block">
                              Concerns & Risks:
                            </strong>{" "}
                            {insights.cons}
                          </p>
                          <p className="border-t border-border/10 pt-1.5 italic text-foreground">
                            <strong className="uppercase text-[7px] text-foreground not-italic block">
                              Summary Advice:
                            </strong>{" "}
                            {insights.summary}
                          </p>
          ...
          <BrutalCard className="border-2 border-border bg-surface p-5 rounded-sm">
            ...
            <div className="flex flex-wrap gap-1.5">
              {job.skillsRequired.map((skill) => (
                <Badge
                  key={skill}
                  className="text-[9px] font-black uppercase tracking-wider bg-surface border-2 border-border text-foreground px-2 py-0.5"
                >
                  {skill}
                </Badge>
              ))}
      ...
      {similarJobs.length > 0 && (
        <div className="space-y-3.5 border-t border-border/10 pt-6">
          <h3 className="text-xs font-black uppercase tracking-widest text-foreground flex items-center gap-1.5">
            <TrendingUp className="h-4 w-4 text-primary" /> Similar
            Opportunities
          </h3>
          <motion.div
            variants={container}
          ...
          >
            {similarJobs.map((simJob) => (
              <motion.div variants={item} key={simJob.id} className="h-full">
                ...
                >
                  <h4 className="text-xs font-black uppercase truncate text-foreground leading-tight">
                    {simJob.title}
                  </h4>
                  <p className="text-[9px] font-bold text-primary uppercase mt-1">
                    {simJob.companyInfo.name}
                  </p>
      ...
      <div className="md:hidden fixed bottom-0 left-0 right-0 z-40 bg-surface border-t-[3px] border-border p-3 flex gap-2.5 brutal-shadow-reverse">
        <Button
          ...
          onClick={() => {
            toggleSaveJob(job);
            toast.success(
              job.isSaved ? "Removed from Saved Jobs" : "Saved to Saved Jobs!",
            );
          }}
